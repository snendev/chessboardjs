...
(function () {
  ...
  function constructor(containerElOrString, config) {
    ...
    function buildPieceHTML(piece, { hidden, id, square }) {
      var html = "<div ";
      if (isString(id) && id !== "") {
        html += 'id="' + id + '" ';
      }
    ...
    function buildSparePiecesHTML(color) {
      ...
      for (var i = 0; i < pieces.length; i++) {
        html += buildPieceHTML(pieces[i], {
          hidden: false,
          id: sparePiecesElsIds[pieces[i]],
        });
      }
    ...
    function drawPositionInstant() {
      ...
      for (var i in currentPosition) {
        ...
        $("#" + squareElsIds[i]).append(
          buildPieceHTML(currentPosition[i], { square: i }),
        );
      }
    }
    ...
    function snapbackDraggedPiece() {
      ...
      var sourceSquarePosition = $("#" + squareElsIds[draggedPieceSource])
        .offset();
    ...
    function stopDraggedPiece(location) {
      ...
      if (isFunction(config.onDrop)) {
        ...
        $draggedPiece.attr("data-piece", "wP").empty();
    ...
    function mousedownSquare(evt) {
      ...
      } else if (isFunction(config.onClickEmptySquare)) {
        config.onClickEmptySquare(square);
      }
    }
    ...
    function initDOM() {
      ...
      $("body").append(
        buildPieceHTML("wP", { hidden: true, id: draggedPieceId }),
      );
